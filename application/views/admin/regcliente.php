...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body oncontextmenu="return false">
        <section>  
            <table id="dg" title="Registro De Usuarios" class="easyui-datagrid" style="width:800px;height:250px"
                   url="regcliente" toolbar="#toolbar" pagination="true" rownumbers="true" fitColumns="true" singleSelect="true">
                <thead>
                    <tr>
            ...
            <div name="dlg" id="dlg" class="easyui-dialog" style="width:300px;height:360px;padding:10px 20px" closed="true"
                ...
                <form id="formulario" name="formulario" method="post" action="agregar">
                    ...
                    <div class="fitem">
                        ...
                        <label>Cedula:</label>
                        <input id="cedula" name="cedula" class="easyui-textbox" required="true">
            ...
            <div name="dl" id="dl" class="easyui-dialog" style="width:300px;height:250px;padding:10px 20px"
                ...
                <form id="formu" name="formu" method="post" action="eliminar">
                    ...
                    <div class="fitem">
                        ...
                        <label>NIT:</label>
                        <input id="cedula" name="cedula" disabled="true" class="easyui-textbox" required="true">
                    </div>
                </form>
            </div>
            <div id="dlg-buttons">
